...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    driverController
        .povRight()
        .onTrue(new ElevatorController(m_elevator, Constants.ElevatorConstants.L1Position));

    // move to l2
    driverController
        .povDown()
        .onTrue(new ElevatorController(m_elevator, Constants.ElevatorConstants.L2Position));

    // move to l3
    driverController
        .povLeft()
        .onTrue(new ElevatorController(m_elevator, Constants.ElevatorConstants.L3Position));

    // move to l4
    driverController
        .povUp()
        .onTrue(new ElevatorController(m_elevator, Constants.ElevatorConstants.L4Position));
        ...
        .onTrue(
            new SequentialCommandGroup(
                new ParallelCommandGroup(
                        ...
                        new EndEffectorPivotController(
                            m_endeffectorpivot,
                            Constants.EndEffectorConstants.PivotConstants.L2Angle))
                    .withTimeout(0.4),
